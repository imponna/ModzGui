...
ToggleS.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
ToggleS.Position = UDim2.new(0.01, 0, 0.13, 0)
ToggleS.Size = UDim2.new(0, 65, 0, 65)
ToggleS.Font = Enum.Font.SourceSansSemibold
ToggleS.Text = "SPX"
ToggleS.TextColor3 = Color3.fromRGB(0, 0, 0)
ToggleS.TextSize = 40.0

local UICorner = Instance.new("UICorner")
UICorner.Parent = ToggleS

ToggleS.MouseButton1Click:Connect(function()
    local RippleHUBLIB = game.CoreGui:FindFirstChild("RippleHUBLIB")
    if RippleHUBLIB then
        RippleHUBLIB.Enabled = not RippleHUBLIB.Enabled
    end
end)

ToggleS.MouseButton1Click:Connect(function()
    local RippleHUBLIB = game.CoreGui:FindFirstChild("RippleFPS")
    if RippleFPS then
        RippleFPS.Enabled = not RippleFPS.Enabled
    end
end)

ToggleS.MouseButton1Click:Connect(function()
    local RippleHUBLIB = game.CoreGui:FindFirstChild("Ripple")
    if Ripple then
        Ripple.Enabled = not Ripple.Enabled
    end
end)
